...
const shows = [
  {
    ...
    description:
      "Premier grand projet musical avec le Jarrie's Gospel Choir. Reprises de morceaux afro-américains réarrangés. Une cinquantaine de jeunes sur scène.",
    audience: "750",
  ...
  },
  {
    ...
    title: "L'Équilibre",
    type: "Spectacle",
    theme: "Liberté d'être soi",
    description:
      "Entre solos, danses, masques et couleurs : un spectacle sur la liberté, la démocratie et le bonheur d'être pleinement soi. Salué par l'Inspection Académique.",
    audience: "900",
    image: "/scene-06.png",
    cd: null,
    color: "violet",
  ...
  },
  {
    ...
    type: "Spectacle",
    theme: "Amour, Amitié & Tolérance",
    description:
      "Ambiance cabaret intime, lumières tamisées, tables rondes. 45 artistes sur scène, à guichet fermé. Chants en français et anglais sur l'amour et l'amitié.",
    audience: "600",
    image: "/photo-15.jpg",
    ...
    quote:
      "\"Un spectacle époustouflant d'une qualité remarquable.\" — Lettre d'un spectateur",
  },
  {
    year: "2019",
    title: "Résistances",
    type: "Comédie Musicale",
    theme: "Résistance & Courage",
    description:
      "45 bénévoles mobilisés pour ce spectacle majeur. Jeux de lumières, décors, costumes élaborés. Un spectacle total porté par une équipe exceptionnelle.",
    audience: "800",
    image: "/photo-17.jpg",
  ...
  },
  {
    ...
    description:
      "50 artistes (8 à 20 ans), adultes amateurs et intermittents grenoblois. CD \"20 Temps\" enregistré. Reportage France 3. Spectacles à L'Oriel de Varces.",
    audience: "1200",
